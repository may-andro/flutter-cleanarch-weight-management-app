    ...
    return Padding(
      ...
      child: Container(
        ...
        child: RaisedButton(
          ...
          child: isClickable ? Text(text,
              style: TextStyle(color: Colors.white, fontSize: MediaQuery.of(context).size.shortestSide * 0.04)) : SizedBox(height: 16, width: 16, child: CircularProgressIndicator() ,)
          ,
